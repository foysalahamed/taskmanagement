...
import static com.taskmanager.taskmanager.constant.TaskManagerApiConstants.ROLE_ADMIN;
import static com.taskmanager.taskmanager.constant.TaskManagerApiConstants.ROLE_USER;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().authorizeRequests()
			    ...
			    .antMatchers("/createTask/").hasRole(ROLE_USER)
