package com.taskmanager.taskmanager.constant;

public final class TaskManagerApiConstants {

	/* message source */
	public static final String API_ERROR_SOURCE = "Error";
	...
	public static final String MSG_INSERT_SUCCESS = "Insert Successfully!";
